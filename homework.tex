...
\section*{Problem 6}
\subsection*{(iii)}
	We consider three kinds of classifiers: naive-bayes, nearest neighbor (KNN), and decision tree. Here, we are working with word vectors with stop words and numbers removed, so as to improve runtime and reduce noise.
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=.5]{q6_fig/knn.png}	
		\caption{Positive Predictive Parity Condition of Classifiers}
	\end{figure}
